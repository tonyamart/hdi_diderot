...
-   using the metadata compiled, there are three tags for each fragment
...
grep("ed", rownames(dtm)) # check the position of texts in question
```
...
for (i in 1:50) {
  ...
  for (s in c(13, 14)) {
    ...
    r <- imposters(reference.set = data[-c(13, 14),], # remove test data from the ref
                   ...
                   features = 0.33, # test 50% of the features in each trial
                   iterations = 100,
                   distance = "wurzburg"
                   )
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1770_nch74_nch80.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_1770_nch74_nch80__33.rds")

op_list_w <- readRDS("imp_res/0_main_res/ed1770-nch-nch_optimise_list_w.rds")
...
```{r}
imp_res <- readRDS("imp_res/0_main_res/impr_1770_nch74_nch80.rds")
...
fig_2a <- imp_res %>%
  ...
  mutate(candidate = ifelse(candidate == "Rivière", "La Rivière", candidate)) %>%
  
  # filter top authors for the plot
  filter(candidate %in% c("Diderot", "d'Holbach", "La Rivière", "Saint-Lambert", "Condorcet", "Deleyre", "Pechmeja", "Baudeau")) %>% 
  ggplot(aes(x = reorder(candidate, proportion),
  y = proportion)) + 
...
saveRDS(op_list_w, "imp_res/0_main_res/ed1770-CH-nch_optimise_list_w.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1770_ch74_nch80__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_1770_ch74_nch80.rds")

op_list_w <- readRDS("imp_res/0_main_res/ed1770-CH-nch_optimise_list_w.rds")
...
imp_res %>%
  ...
  # 
  theme_bw() + 
  labs(subtitle = "Proportion of cases where a sample from an author was the closest one\nto FV text from 1770 that was changed in the ed. of 1774 and not changed in the ed. of 1780\nN words in problem text = 5690", x = "") +
  theme(axis.text.x = element_text(angle = 25))

# ggsave(filename = "imp_res/0_plots_main/2_ed1770-ch-nch.png", plot = last_plot(),
#        bg = "white", width = 8, height = 6)
```

```{r}
mean_gi(imp_res) %>% head(5)
```
...
saveRDS(op_list_w, "imp_res/0_main_res/ed1770-CH-CH_optimise_list_w.rds")
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1770_ch74_ch80__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_1770_ch74_ch80.rds")

op_list_w <- readRDS("imp_res/0_main_res/ed1770-CH-CH_optimise_list_w.rds")
...
imp_res %>%
  ...
  # 
  theme_bw() + 
  labs(subtitle = "Proportion of cases where a sample from an author was the closest one\nto FV text from 1770 that was changed twice in the ed. of 1774 and that of 1780\nN words in problem text = 16882", x = "") +
  theme(axis.text.x = element_text(angle = 25))

ggsave(filename = "imp_res/0_plots_main/4_ed1770-ch-ch.png", plot = last_plot(),
       bg = "white", width = 8, height = 6)
```
...
saveRDS(op_list_w, "imp_res/0_main_res/ed1770-nch-CH_optimise_list_w.rds")
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1770_nch74_ch80__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_1770_nch74_ch80.rds")

op_list_w <- readRDS("imp_res/0_main_res/ed1770-nch-CH_optimise_list_w.rds")
...
imp_res %>%
  ...
  # 
  theme_bw() + 
  labs(subtitle = "Proportion of cases where a sample from an author was the closest one\nto FV text from 1770 that was not changed in the ed. of 1774 and changed in the ed. of 1780\nN words in problem text = 18198", x = "") +
  theme(axis.text.x = element_text(angle = 25))

# ggsave(filename = "imp_res/0_plots_main/3_ed1770-nch-ch.png", plot = last_plot(),
#        bg = "white", width = 8, height = 6)
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1774_nch80__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_1774_nch80.rds")

op_list_w <- readRDS("imp_res/0_main_res/ed1774-nch-optimise_list_w.rds")
...
imp_res %>%
  ...
  # 
  theme_bw() + 
  labs(subtitle = "Proportion of cases where a sample from an author was the closest one\nto FV text from the ed. of 1774 and not changed in the ed. of 1780\nN words in problem text = 4804",
       x = "") +
  theme(axis.text.x = element_text(angle = 25,
                                   size = 12))

# ggsave(filename = "imp_res/0_plots_main/5_ed1774-nch.png", plot = last_plot(),
#        bg = "white", width = 8, height = 6)
```
...
saveRDS(op_list_w, "imp_res/0_main_res/ed1774-CH_optimise_list_w.rds")
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1774_ch80__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_1774_ch80.rds")

op_list_w <- readRDS("imp_res/0_main_res/ed1774-CH_optimise_list_w.rds")
...
imp_res %>%
  ...
  # 
  theme_bw() + 
  labs(subtitle = "Proportion of cases where a sample from an author was the closest one\nto FV text from the ed. of 1774 and changed in the ed. of 1780\nN words in problem text = 18373",
       x = "") +
  theme(axis.text.x = element_text(angle = 25))

# ggsave(filename = "imp_res/0_plots_main/6_ed1774-ch.png", plot = last_plot(),
#        bg = "white", width = 8, height = 6)
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1780__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_1780.rds")

op_list_w <- readRDS("imp_res/0_main_res/ed1780-optimise_list_w.rds")
...
imp_res %>%
  ...
  # 
  theme_bw() + 
  labs(subtitle = "Proportion of cases where a sample from an author was the closest one\nto FV text from the ed. of 1780\nN words in problem text = 86421", x = "") +
  theme(axis.text.x = element_text(angle = 25))

#ggsave(filename = "imp_res/0_plots_main/7_ed1780.png", plot = last_plot(),
#       bg = "white", width = 8, height = 6)
```
...
imp_res %>%
  ...
  # filter top authors for the plot
  filter(candidate %in% c("Diderot", "d'Holbach", "La Rivière", "Saint-Lambert", "Condorcet", "Morellet", "Pechmeja", "Baudeau")) %>% 
  ggplot(aes(x = reorder(candidate, proportion),
  y = proportion)) + 
  geom_boxplot(aes(fill = gr)) + 
  ...
  coord_flip() + 
  scale_fill_manual(values = met.brewer("Kandinsky")[2:4]) + 
  labs(subtitle = "Proportion of cases where a sample from an author was the closest one\nto FV text from 1780", x = "Candidates (top-7 + Diderot)", y = "Proportion\n(dashed line shows CI with results between the lines being uncertain)") +
  theme(#axis.text.x = element_text(angle = 25)
        axis.text = element_text(size = 12),
        plot.subtitle = element_text(size = 14),
        legend.position = "None"
...
D'Holbach's signal is stronger in case of the earliest editions (1770 & not changed later), in cases of 1770-nch-nch, 1770-ch-nch & 1774-nch confidence interval proves that d'Holbach is the only robust and most frequent first candidate for the authorship.
...
for(i in 1:20) {
  ...
  op_list_w[[i]] <- imposters.optimize(data[-c(25, 26),])
...
saveRDS(op_list_w, "imp_res/0_main_res/pencil_optimise_list_w.rds")
...
saveRDS(imp_res, "imp_res/0_main_res/impr_pencil_33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_pencil.rds")

op_list_w <- readRDS("imp_res/0_main_res/pencil_optimise_list_w.rds")
...
# ggsave(filename = "imp_res/0_plots_main/8_pencil.png", plot = last_plot(),
#        bg = "white", width = 8, height = 6)

imp_res %>%
  bind_rows() %>%  #stack all the optained prop tables into one 
  mutate(candidate = str_remove(candidate, "^/")) %>% 
  filter(candidate %in% c("Diderot", "Saint-Lambert", "Pechmeja", "Condorcet", "dHolbach", "Baudeau", "Deleyre",  "Rivière")) %>% 
  mutate(gr = ifelse(candidate == "Diderot", "d", "no")) %>% 
  mutate(candidate = ifelse(candidate == "Rivière", "La Rivière", candidate)) %>%
  mutate(candidate = ifelse(candidate == "dHolbach", "d'Holbach", candidate)) %>% 
  ggplot(aes(x = reorder(candidate, proportion),
  ...
  coord_flip() + 
  scale_fill_manual(values = met.brewer("Kandinsky")[2:4]) + 
  labs(subtitle = "Proportion of cases where a sample from an author \nwas the closest one to FV texts from Pensées détachées (pencil)", x = "Candidates (selected)", y = "Proportion\n(dashed line shows CI with results between the lines being uncertain)") +
  theme(#axis.text.x = element_text(angle = 25)
        axis.text = element_text(size = 12),
...
for(i in 1:20) {
  ...
  op_list_w[[i]] <- imposters.optimize(data[-c(15, 16),])
...
saveRDS(op_list_w, "imp_res/0_main_res/ink_optimise_list_w.rds")
...
saveRDS(imp_res, "imp_res/0_main_res/impr_ink__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_ink.rds")

op_list_w <- readRDS("imp_res/0_main_res/ink_optimise_list_w.rds")
...
# ggsave(filename = "imp_res/0_plots_main/9_ink.png", plot = last_plot(),
#        bg = "white", width = 8, height = 6)
```

```{r}
mean_gi(imp_res) %>% head(8)
```
...
fig_3a <- imp_res %>%
  ...
  coord_flip() + 
  scale_fill_manual(values = met.brewer("Kandinsky")[2:4]) + 
  labs(subtitle = "Proportion of cases where a sample from an author \nwas the closest one to FV texts from Mélanges (ink)", x = "Candidates (selected)", y = "Proportion\n(dashed line shows CI with results between the lines being uncertain)") +
  theme(#axis.text.x = element_text(angle = 25)
        axis.text = element_text(size = 12),
        plot.subtitle = element_text(size = 16),
        legend.position = "None"
...
It is unlikely that any of the selections (either in pencil or in ink) are Diderot's texts. However, our method is not sure about any of the authors to be the candidate for the authorship.
...
saveRDS(imp_res, "imp_res/0_main_res/impr_rus-china.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_rus-china.rds")
...
saveRDS(op_list_w, "imp_res/0_main_res/sauvage_optimise_list_w.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_sauvage__33.rds")
```

```{r, echo=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_sauvage.rds")

op_list_w <- readRDS("imp_res/0_main_res/sauvage_optimise_list_w.rds")
...
fig_4a <- imp_res %>%
  bind_rows() %>%  #stack all the optained prop tables into one 
  mutate(candidate = str_remove(candidate, "^/")) %>% 
  filter(candidate %in% c("Diderot", "Pechmeja", "Morellet", "Rivière", "Condorcet", "dHolbach", "Saint-Lambert",  "Baudeau")) %>% 
  mutate(gr = ifelse(candidate == "Diderot", "d", "no")) %>% 
  mutate(candidate = ifelse(candidate == "Rivière", "La Rivière", candidate)) %>%
  mutate(candidate = ifelse(candidate == "dHolbach", "d'Holbach", candidate)) %>%
  ggplot(aes(x = reorder(candidate, proportion),
  ...
  coord_flip() + 
  scale_fill_manual(values = met.brewer("Kandinsky")[2:4]) + 
  labs(subtitle = "Proportion of cases where a sample from an author was \nthe closest one to the fragment 'Les avantages de la vie sauvage'", x = "Candidates (selected)", y = "Proportion\n(dashed line shows CI with results between the lines being uncertain)") +
  theme(#axis.text.x = element_text(angle = 25)
        axis.text = element_text(size = 12),
        plot.subtitle = element_text(size = 16),
        legend.position = "None"
...
Although Diderot is the first among the authors being the closest to the target text, it is visible already from the boxplots, that the result on average is pretty low (\~0.4). CI confirms that the decision is far from being final.
...
saveRDS(imp_res, "imp_res/0_main_res/impr_fr-51-55-72-40.rds")
```

```{r, echo=FALSE, eval=FALSE}
imp_res <- readRDS("imp_res/0_main_res/impr_fr-51-55-72-40.rds")
...
fl <- list.files(path = "imp_res/1_add_res/",
                 pattern = ".rds",
                 full.names = TRUE)

author_res <- tibble(path = fl,
                     title = str_remove_all(
                       path, "imp_res/1_add_res//|\\.rds"),
                     author = title) 
...
for (i in 1:length(unique_authors)) {
  ...
  for (j in 1:nrow(author_subset)) {
    ...
    plt1 <- plt(imp_res, author = "Diderot", work = w)
    
  }
  
  pltfh <- paste0("imp_res/1_plots_additional/", a, ".png")
  ggsave(filename = pltfh, plot = plt1,
