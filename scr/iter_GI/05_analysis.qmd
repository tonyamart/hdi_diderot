...
saveRDS(imp_res, "imp_res/0_main_res/impr_1770_ch74_nch80.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1770_ch74_ch80.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1770_nch74_ch80.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1774_nch80.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1774_ch80.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_1780.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_pencil.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_ink.rds")
```
...
saveRDS(imp_res, "imp_res/0_main_res/impr_sauvage.rds")
```
